// AHB Interface (no SVA assertions)
// Based on vip/AHB2/rtl/ahb_intf.sv by Mayur Kubavat
// Modifications: HRESETn changed from internal logic to input port; SVA section removed
